      ...
      <div className="chronicle-card">
        ...
        <form onSubmit={handleSubmit} className="chronicle-form">
              ...
              <div className="password-strength">
                ...
                <div className="validation-grid">
                  <div className="validation-item">
                    ...
                    <span className="validation-text">Mínimo 8 caracteres</span>
                  </div>
                  <div className="validation-item">
                    <span className={`validation-icon ${validations.uppercase ? 'valid' : 'invalid'}`}>
                      {validations.uppercase ? '✓' : '○'}
                    </span>
                    <span className="validation-text">Uma maiúscula</span>
                  </div>
                  <div className="validation-item">
                    <span className={`validation-icon ${validations.lowercase ? 'valid' : 'invalid'}`}>
                      {validations.lowercase ? '✓' : '○'}
                    </span>
                    <span className="validation-text">Uma minúscula</span>
                  </div>
                  <div className="validation-item">
                    <span className={`validation-icon ${validations.number ? 'valid' : 'invalid'}`}>
                      {validations.number ? '✓' : '○'}
                    </span>
                    <span className="validation-text">Um número</span>
                  </div>
                  <div className="validation-item">
                    <span className={`validation-icon ${validations.special ? 'valid' : 'invalid'}`}>
                      {validations.special ? '✓' : '○'}
                    </span>
                    <span className="validation-text">Um carácter especial</span>
                  </div>
                </div>
              </div>
            )}
          ...
          <div className="form-options">
            <label className="checkbox-container">
              ...
              <span className="checkbox-label">
                Concordo com os <Link to="/terms" className="terms-link">Termos de Serviço</Link> e <Link to="/privacy" className="terms-link">Política de Privacidade</Link>
              </span>
            </label>
          </div>
          ...
          >
            <span className="button-text">
              {loading ? 'Criando cápsula...' : 'Criar Cápsula do Tempo'}
            </span>
        ...
        <div className="chronicle-footer">
          ...
          <div className="security-badge">
            ...
            <span>Criptografia temporal ativa</span>
          </div>
        </div>
      </div>
